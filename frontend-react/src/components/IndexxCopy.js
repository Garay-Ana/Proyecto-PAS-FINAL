                ...
                <div className="form-row">
                  <div className="form-col">
                    <div className="form-group">
                      ...
                      <input type="text" id="uid" className="form-control" required />
                        ...
                        <tbody>
                          {[...timeRecords]
                            ...
                            .map((record, index) => {
                              ...
                              const fechaEntrada = new Date(record.entrada);
                              const fechaSalida = record.salida ? new Date(record.salida) : null;

                              let tiempoTotal = '-';
                              let estado = '<span style="color: green;">✓ Activo</span>';
                              ...
                              if (fechaSalida) {
                                ...
                                estado = '<span style="color: red;">● Finalizado</span>';
                              }
                              ...
                              return (
                                <tr key={index}>
                                  ...
                                  <td className="timestamp">{fechaEntrada.toLocaleTimeString('es-ES')}</td>
                                  <td className="timestamp">{fechaSalida ? fechaSalida.toLocaleTimeString('es-ES') : '-'}</td>
                                  <td><strong>{tiempoTotal}</strong></td>
                                  <td dangerouslySetInnerHTML={{ __html: estado }}></td>
                                </tr>
                              );
                            })}
                        </tbody>
